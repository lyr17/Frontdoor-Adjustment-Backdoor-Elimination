...
class Trainer(object):
    ...
    def train_one_epoch(self, epoch: int, epoch_iterator, model:Victim):
        """
    ...
    def train(self, model: Victim, dataset, metrics: Optional[List[str]] = ["accuracy"]):
        ...
        for epoch in range(self.epochs):
            ...
            epoch_loss, poison_loss, normal_loss = self.train_one_epoch(epoch, epoch_iterator, model)
    ...
    def model_checkpoint(self, ckpt: str):
        return os.path.join(self.save_path, f'{ckpt}.pkl')
